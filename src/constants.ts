...
export function mapApiDataToPokemon(apiData: any): Pokemon {
    ...
    const characteristics: PokemonCharacteristics = {
        hp: apiData.stats.find((stat: any) => stat.stat.name === 'hp')
            .base_stat,
        attack: apiData.stats.find((stat: any) => stat.stat.name === 'attack')
            .base_stat,
        defense: apiData.stats.find((stat: any) => stat.stat.name === 'defense')
            .base_stat,
        speed: apiData.stats.find((stat: any) => stat.stat.name === 'speed')
            .base_stat,
    }
